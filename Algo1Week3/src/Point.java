...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        if (that == null)
            throw new NullPointerException("Can not be null Point");
    ...
    public Comparator<Point> slopeOrder() {
        return new ComparePoints<Point>();
    }

    private class ComparePoints<PointT> implements Comparator<Point> {
        @Override
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(p1.slopeTo(p2) + ", " + p1.slopeTo(p3) + ", " +
        // p1.slopeTo(p4) + ", "+ p3.slopeTo(p2)+ ", "+ p1.slopeTo(p5));
        // System.out.println(p1.compareTo(p1) + ", " + p4.compareTo(p3) + ", "
        // + p1.compareTo(p4) + ", "+ p5.compareTo(p1));
